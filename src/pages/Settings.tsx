      ...
      <div className="pt-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Receive updates about your briefs</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Get a weekly summary of your activity</p>
                </div>
          ...
          >
            ...
            <div className="space-y-4">
              <button className="flex items-center gap-3 w-full p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors text-left">
                <Download className="w-5 h-5 text-gray-400" />
                <div>
                  <h3 className="text-white font-medium">Export Data</h3>
                  <p className="text-gray-400 text-sm">Download all your briefs and data</p>
                </div>
              </button>
              <button className="flex items-center gap-3 w-full p-3 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 rounded-lg transition-colors text-left">
